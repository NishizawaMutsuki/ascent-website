...
export default function HpLandingPage() {
  ...
  const faqItems = [
    ...
    { q: "制作期間はどれくらいですか？", a: "全プラン2週間での公開を目標にしています。オプション（写真撮影・ロゴ制作等）が含まれる場合はスケジュールが前後することがありますので、詳細はご相談ください。" },
    ...
    { q: "ドメインは誰の名義になりますか？", a: "先生（医院）の名義で取得します。解約後もそのままお使いいただけますので、ご安心ください。" },
