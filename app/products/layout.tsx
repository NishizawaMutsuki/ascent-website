...
function AscentLogo() {
  return (
    <svg width="160" height="38" viewBox="0 0 180 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Ascent">
      <path d="M8 38L20 8L26 22L32 8L44 38" stroke="url(#navPeakGrad2)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
      <path d="M14 38L20 24L26 30L32 18L38 38" stroke="url(#navPeakGrad2)" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.3"/>
      <text x="54" y="32" fontFamily="'Outfit', sans-serif" fontWeight="600" fontSize="24" fill="#e8e8ed" letterSpacing="-0.02em">Ascent</text>
      <defs>
        <linearGradient id="navPeakGrad2" x1="0" y1="38" x2="44" y2="8">
  ...
  return (
    <nav className="nav">
      <div className="nav-inner">
        <a href="/" className="nav-logo-link"><AscentLogo /></a>
